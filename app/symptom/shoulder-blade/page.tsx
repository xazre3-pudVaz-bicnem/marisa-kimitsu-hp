...
const scenes = [
  {
    ...
    desc: '事務職・テレワーク勤務の方を中心に、背中の板状の固さでご来店される方が多くいらっしゃいます。週1〜2回の定期ご利用で背中の張りを軽減されている方も多数います。',
  },
  {
    title: '製造業・工場勤務の方',
    desc: '大型工場での中腰・前傾作業が続く方も肩甲骨まわりに緊張が溜まりやすい傾向があります。仕事帰りに立ち寄り、背中の疲れをリセットするご利用が人気です。',
  },
  {
    title: '子育て中・家事が多い方',
