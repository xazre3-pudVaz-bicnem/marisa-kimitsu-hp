...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい、鍼灸メニューで腰へのアプローチも可能です。担当の鍼灸師「なお」が腰の気になる部位にピンポイントで鍼アプローチを行います。鍼灸メニューは公式WEB予約限定で、なおは金曜10:00-22:00・土曜10:00-14:00が基本勤務時間です。ホットペッパービューティーからは予約できませんのでご注意ください。',
      },
    },
    {
      '@type': 'Question',
...
const menuItems = [
  ...
  },
  {
    ...
    note: '鍼灸メニューは公式WEB予約限定です。ホットペッパービューティーからは予約できません。金曜10:00-22:00、土曜10:00-14:00が基本勤務時間です。',
  },
]
...
const faqs = [
  ...
  {
    q: '鍼灸で腰をケアできますか？',
    a: 'はい、鍼灸メニューで腰へのアプローチも可能です。担当の鍼灸師「なお」が腰の気になる部位にピンポイントで鍼アプローチを行います。鍼灸メニューは公式WEB予約限定で、ホットペッパービューティーからは予約できません。なおの基本勤務は金曜10:00-22:00・土曜10:00-14:00です。',
  },
  {
    q: '足つぼと腰のつらさは関係ありますか？',
...
const flowSteps = [
  { step: '01', title: '予約', desc: '公式WEB・ホットペッパービューティー・お電話でご予約ください。鍼灸は公式WEB予約限定です。' },
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="border border-sand-200 bg-cream-50 p-6">
              ...
              <p className="text-sm text-stone-700 leading-loose">国家資格を持つ鍼灸師。腰の鍼灸施術を担当します。金曜10:00-22:00、土曜10:00-14:00が基本勤務。公式WEB予約でご予約ください。</p>
            </div>
            <div className="border border-sand-200 bg-cream-50 p-6">
