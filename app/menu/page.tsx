...
export const metadata: Metadata = {
  ...
  description:
    '千葉県君津市のリラクゼーションサロン「MARISA」のメニュー・料金一覧。もみほぐし・ヘッドセット・足つぼセット・ヘッドケアをご用意。45分¥3,500〜。当日予約OK・夜0時まで営業。',
...
const menus = [
  {
    ...
    courses: [
      { name: 'もみほぐし 45分', price: '¥3,500〜', desc: '首・肩・背中・腰を中心にケア。短時間でしっかりほぐしたい方に。' },
      { name: 'もみほぐし 60分', price: '¥4,500〜', desc: '全身の疲れをじっくりとケアする定番コース。仕事帰りに最適。', badge: '人気' },
      { name: 'もみほぐし 90分', price: '¥6,500〜', desc: 'ゆっくり時間をかけて、深部の疲れまでしっかりケアします。' },
    ],
  },
  {
    category: 'ヘッドセット',
    ...
    courses: [
      { name: 'ヘッドセット 60分', price: '¥5,000〜', desc: 'もみほぐし＋ヘッドケアの組み合わせ。頭・首・肩をまとめてケア。', badge: 'おすすめ' },
      { name: 'ヘッドセット 90分', price: '¥7,000〜', desc: 'ゆっくり時間をかけてもみほぐしとヘッドを両方満喫できるコース。' },
      { name: 'ヘッドセット 120分', price: '¥9,000〜', desc: '全身をじっくりケアしながらヘッドも堪能。休日の特別なご褒美に。' },
    ],
  },
  {
    category: '足つぼセット',
    href: '/menu/set',
    en: 'Foot Set',
    desc: 'もみほぐしと足つぼ・リフレクソロジーを組み合わせたセットコース。足裏の反射区を刺激し、体全体の疲れを奥から解消します。',
    recommend: '立ち仕事の足の疲れ・むくみ・冷え性の方に',
    courses: [
      { name: '足つぼセット 45分', price: '¥4,000〜', desc: 'もみほぐしと足つぼを短時間で組み合わせたコース。' },
      { name: '足つぼセット 60分', price: '¥5,500〜', desc: 'ゆったりとした時間でもみほぐしと足つぼをじっくり体験。', badge: 'おすすめ' },
    ],
  },
  {
    category: 'ヘッドケア単体',
    ...
    courses: [
      { name: 'ヘッドケア 30分', price: '¥2,500〜', desc: '頭・側頭部・眼周りを集中的にケア。短時間で頭をすっきりリセット。' },
    ],
  },
]
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="mt-4">
            ...
            <p className="mt-4 text-stone-700 text-sm leading-loose max-w-2xl">
              もみほぐし・ヘッドセット・足つぼセット・ヘッドケアなど、お体の状態やお悩みに合わせて選べるコースをご用意しています。初めての方にも丁寧にご案内しますので、お気軽にご相談ください。
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-14 bg-sand-100">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <p className="text-xs tracking-widest text-greige-400 uppercase mb-6">Explore Menus</p>
      ...
      <section className="py-10 bg-cream-100">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          <div className="border border-sand-200 p-6 bg-cream-50">
            <p className="text-xs tracking-widest text-greige-400 uppercase mb-2">Notice</p>
            <p className="text-sm text-stone-700 leading-loose">
              鍼灸・美容鍼については現在提供中か未確定のため、最新情報は
              <a
                href="https://www.instagram.com/momihogushi_marisa/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-brown-400 hover:text-brown-500 underline underline-offset-2"
              >
                Instagram（@momihogushi_marisa）
              </a>
              にてご確認ください。
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm text-stone-700 leading-loose">
            ...
            <div className="border-l-2 border-sand-200 pl-4">
              ...
              <p>ネット予約・当日予約OK<br />お電話でもご相談いただけます</p>
            </div>
            <div className="border-l-2 border-sand-200 pl-4">
