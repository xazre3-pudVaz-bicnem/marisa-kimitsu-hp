...
export const metadata: Metadata = {
  ...
  description:
    '千葉県君津市のリラクゼーションサロン「MARISA」の鍼灸メニュー。もみほぐしと鍼を組み合わせたケアで、気になる部位に丁寧にアプローチします。君津で鍼灸をお探しの方に。当日予約OK・夜0時まで営業。',
  keywords: ['君津 鍼灸', '君津 鍼 もみほぐし', '君津 美容鍼', '君津 美顔鍼'],
  openGraph: {
    title: '鍼灸メニュー | もみほぐし・MARISA 君津店',
    description:
      '千葉県君津市のリラクゼーションサロン「MARISA」の鍼灸メニュー。もみほぐしと鍼を組み合わせたケアで、気になる部位に丁寧にアプローチします。',
    locale: 'ja_JP',
    type: 'website',
  },
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          ...
          <div className="mt-4">
            ...
            <p className="mt-4 text-stone-700 text-sm leading-loose max-w-2xl">
              君津のリラクゼーションサロン「MARISA」では、もみほぐしと鍼を組み合わせたケアをご提供しています。資格を持つ鍼灸師「なお」が担当し、気になる部位に丁寧にアプローチします。君津で鍼灸をお探しの方に。
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-14 bg-cream-50">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          ...
          <div className="border border-sand-200 bg-sand-100 p-6">
            ...
            <p className="text-sm text-stone-700 leading-loose">
              鍼灸師の国家資格を保有するスタッフです。鍼灸メニューおよびもみほぐし＋鍼の組み合わせコースはすべてなおが担当します。初めて鍼を受ける方にも丁寧にご説明しながら施術を行いますので、不安なことがあればお気軽にご相談ください。
            </p>
          </div>
        </div>
      </section>
