...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'はい、セットコースも当日予約に対応しています。WEB予約（ホットペッパービューティー）からお選びください。満席の場合はご希望に添えないこともございますので、事前のご予約をおすすめしています。',
      },
    },
    {
      '@type': 'Question',
...
const steps = [
  {
    step: '01',
    title: 'ご予約',
    desc: 'WEB予約（ホットペッパービューティー）から希望のセットコースをお選びください。',
  },
  {
    step: '02',
    title: 'ご来店・受付',
...
const faqs = [
  ...
  {
    q: 'セットコースも当日予約できますか？',
    a: 'はい、セットコースも当日予約に対応しています。WEB予約（ホットペッパービューティー）からお選びください。満席の場合はご希望に添えないこともございますので、週末や夜の時間帯は事前のご予約をおすすめしています。',
  },
  {
